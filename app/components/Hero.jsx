  ...
  return (
    <>
      ...
      <Link href="/category/all" className="flex justify-center items-center">
        <span className="text-center text-xl text-gray-700 dark:text-light hover:bg-blue-950 rounded-md hover:text-light border border-gray-600 px-20 py-1 w-full dark:border-light">
          show moore...
        </span>
      </Link>
    </>
