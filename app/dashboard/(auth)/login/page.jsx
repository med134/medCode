          ...
          <div className="p-8 xs:p-4">
            ...
            <form className="mt-8" onSubmit={handelSubmit}>
              <div className="relative mt-2 w-full">
                ...
                <label
                  htmlFor="email"
                  className="absolute top-2 left-1 origin-[0] -translate-y-4 scale-75 transform cursor-text select-none bg-gray-100 px-2 text-sm text-gray-500 duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-blue-600"
                >
                  {" "}
                  Enter Your Email{" "}
                </label>
